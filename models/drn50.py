...
class DRN_50(torch.nn.Module):
    ...
    def __init__(self, num_classes = 2):
        ...
        # block 3
        self.resnet_block_3_1 = self.block_3(512)
        ...
        self.skip_connection_3 = torch.nn.Sequential(
            torch.nn.Conv2d(512, 1024, kernel_size=1),
            torch.nn.BatchNorm2d(1024)
        )
        
        self.skip_connection_4 = torch.nn.Sequential(
            torch.nn.Conv2d(1024, 2048, kernel_size=1),
            torch.nn.BatchNorm2d(2048)
        )
